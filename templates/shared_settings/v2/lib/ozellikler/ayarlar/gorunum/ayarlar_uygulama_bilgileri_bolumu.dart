...
class _AyarlarUygulamaBilgileriBolumuState
  ...
  Widget build(BuildContext context) {
    return AyarlarOrtakBolumKarti(
      baslik: 'Uygulama Bilgileri ve Güncelleme',
      baslikRengi: akordeonBaslikUygulamaBilgi,
      yardimMetni:
          'Bu bölüm uygulama adı, sürüm bilgisi, dağıtım kanalı ve güncelleme kontrolünü gösterir. Güncelleme bilgisi AllApp public dağıtım yapısından okunur.',
      cocuk: FutureBuilder<PackageInfo>(
        ...
        builder: (
          ...
          return Column(
            ...
            children: <Widget>[
              ...
              _bilgiSatiri('Uygulama', UygulamaYapilandirmasi.uygulamaAdi),
              _bilgiSatiri('Sürüm', surum),
              _bilgiSatiri('Release', releaseEtiketi),
              _bilgiSatiri('Dağıtım Kanalı', UygulamaYapilandirmasi.dagitimKanali),
              ...
              FractionallySizedBox(
                ...
                child: FilledButton.icon(
                  onPressed: _guncellemeKontrolEdiliyor
                      ? null
                      : () => unawaited(_guncellemeleriKontrolEt(context)),
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text(
              ...
              '${guncelleme.notes.isEmpty ? '' : '\n\nNotlar: ${guncelleme.notes}'}',
            ),
            actions: <Widget>[
              TextButton(
