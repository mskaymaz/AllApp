          ...
          child: Theme(
            ...
            child: ListTileTheme.merge(
              ...
              child: ExpansionTile(
                ...
                controller: _acilirDenetleyici,
                dense: true,
                maintainState: true,
                initiallyExpanded: _acik,
                expansionAnimationStyle: const AnimationStyle(
                  duration: Duration(milliseconds: 650),
                  curve: Curves.easeInOutCubic,
                ),
                collapsedBackgroundColor: akordeonBaslikDestekOl,
                backgroundColor: akordeonBaslikDestekOl,
                tilePadding: const EdgeInsets.only(right: 20),
                childrenPadding: EdgeInsets.zero,
                onExpansionChanged: (bool acik) {
                  setState(() {
                    _acik = acik;
                  });
                },
